...
class TestBedAdapter:
    ...
    def init_consumers(self):
        logging.info("Initializing kafka consumer helpers")
        if self.test_bed_options.consume:
            self.init_kafka_managers(self.test_bed_options.consume, self.handle_message)
        logging.info("Initialized " + str(len(self.test_bed_options.consume)) + " consumers")
    ...
    def init_producers(self):
        ...
        logging.info("Initialized " + str(len(self.test_bed_options.produce)) + " producers")
